...
#read num;
nice ./bin/visco ../recipe/CsI/test.xml $path_calibData/calibRuns1.root $path_cooked/calib65timeRuns_1.root
#nice ./bin/visco ../recipe/CsI/test.xml $path_decoded/calibRuns.root $path_cooked/calibTimeRun.root
